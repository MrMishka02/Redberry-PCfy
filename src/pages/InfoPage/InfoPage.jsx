...
const InfoPage = () => {
  return (
    <div className="flex h-full w-full flex-col items-center bg-[#FFFFFF]">
      ...
      <div className="mt-16 flex w-[60%] sm:mt-6 sm:w-full sm:flex-col">
        ...
        <div className="flex w-[50%] sm:mt-4 sm:w-full">
          <div className="ml-14 mt-8 w-[30%] sm:ml-4 sm:mt-0 sm:w-[50%]">
      ...
      <div className="mt-[5.3rem] w-[60%] sm:mt-[2.4rem] sm:w-[95%]">
        <Line />
      </div>
      <div className="mt-11 flex w-[60%] sm:mt-5 sm:w-full sm:flex-col sm:overflow-x-hidden">
        <div className="flex w-[50%] sm:ml-4 sm:w-[100%] ">
        ...
        <div className="flex w-[50%] pl-14 sm:ml-4 sm:mt-2 sm:w-full sm:pl-0">
      ...
      <div className="mt-[3.8rem] w-[60%] sm:mt-[2.8rem] sm:w-[95%]">
        <Line />
      </div>
      <div className="mt-11 flex w-[60%] sm:mt-4 sm:w-full sm:flex-col">
        <div className="flex w-[50%] sm:ml-4 sm:flex sm:w-full">
          <div className="w-[50%] sm:w-[48%]">
        ...
        <div className="flex w-[50%] sm:w-full">
          <div className="w-[45%] pl-14 sm:ml-4 sm:w-[50%] sm:pl-0">

...
const PCList = () => {
  return (
    ...
    sm:w-[22.375rem] sm:h-[7.6875rem] sm:ml-0"
    >
      <img src={pcImg} alt="PC" className="ml-4 w-[16.625rem] rounded-xl sm:w-[9rem]" />
      <div className="ml-6 flex h-[56%] w-[40%] flex-col justify-between">
        ...
        <p className="text-lg font-medium text-[#2E2E2E] sm:font-normal">Pentium II</p>
        <p
          className="mt-4 select-none text-base text-[#4386A9]
        underline hover:cursor-pointer sm:text-sm sm:mt-2"
        >
          მეტის ნახვა
        </p>
      </div>
